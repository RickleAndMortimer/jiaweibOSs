...
/*
static void allocateEntry(page_table_t* table, size_t index, uint8_t flags)
{
    void* physical_address = k_malloc(4096);
    setpage_table_tEntry(&(table->entries[index]), flags, (uintptr_t) physical_address >> 12, 0);
}
*/
