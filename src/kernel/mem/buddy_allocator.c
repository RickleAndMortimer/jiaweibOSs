...
//TODO rename this to Slab allocator
void* buddy_malloc(physical_memory_allocator_t* allocator, size_t size) {
...
void buddy_free(physical_memory_allocator_t* allocator, void* address) {
	linked_list_allocator_t* ll_allocator = (linked_list_allocator_t*) allocator;
...
void initialize_buddy_allocator(linked_list_allocator_t* allocator_ptr, size_t capacity, void* base, size_t block_length, size_t* free_list) {
